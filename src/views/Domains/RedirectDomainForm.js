...
const RedirectDomainForm = (props) => {
  ...
  }, [getRedirectDomain, params.id, props]);
        ...
        <CCard>
          ...
          <CCardBody>
            ...
            >
              ...
              <CModalBody>{saveState.info}</CModalBody>
              <CModalFooter>
                <CButton
                  color={saveState.color}
                  onClick={() => savedStatusSetter()}
                >
                  Ok
                </CButton>{' '}
                <CButton color={saveState.color} onClick={() => gotoList()}>
                  Go To List
                </CButton>{' '}
              </CModalFooter>
            </CModal>
...
export default connect(mapStateToProps, mapDispatchToProps)(RedirectDomainForm);
