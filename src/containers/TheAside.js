...
const TheAside = () => {
  ...
  return (
    <CSidebar
      ...
      size='lg'
      overlaid
      show={state.menus.rightSidebar}
      onShowChange={(state) => setState({...state, menus: {...state.menus, rightSidebar: state}})}
    >
      <CSidebarClose onClick={() => setState({...state, menus: {...state.menus, rightSidebar: state}}) } />
      <CTabs>
